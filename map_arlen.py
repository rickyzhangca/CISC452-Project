...
def plot_pr_curve(
    precisions, recalls, category='', label=None, color=None, ax=None):
...
if __name__ == "__main__":
    ...
    with open('truth.json') as infile:
    ...
    # annotations used: https://github.com/fizyr/keras-retinanet-test-data
    iou_thr = 0.7
